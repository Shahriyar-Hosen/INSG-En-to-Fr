<?php
/*
 * Block Pattern - Pros and Cons
 */

function insg_register_pros_and_cons_block_pattern() {
	...
	$content = <<<CONTENT
		...
		<div class="gb-headline gb-headline-e8ea3e67 gb-headline-text">Pros:</div>
		<!-- /wp:generateblocks/headline -->
		
		<!-- wp:list {"style":{"typography":{"fontSize":"18px"}}} -->
		<ul style="font-size:18px"><!-- wp:list-item -->
		<li>Excelent Value</li>
		<!-- /wp:list-item -->
		...
		<div class="gb-headline gb-headline-fdbdee85 gb-headline-text"><strong>Cons:</strong></div>
		<!-- /wp:generateblocks/headline -->
		
		<!-- wp:list {"style":{"typography":{"fontSize":"18px"}}} -->
		<ul style="font-size:18px"><!-- wp:list-item -->
		<li>May crack or shutter</li>
		<!-- /wp:list-item -->
		...
		<!-- wp:list-item -->
		<li>Several reports that it stopped working after a few month</li>
		<!-- /wp:list-item --></ul>
		<!-- /wp:list --></div>
		<!-- /wp:column --></div>
		<!-- /wp:columns -->
...
CONTENT;
	...
	register_block_pattern(
		'insg/pros-and-cons-pattern',
		array(
		    'title'       => __( 'INSG. Pros and Cons', 'insg' ),
		    'description' => _x( 'Custom Pros and Cons layout.', 'Block pattern description', 'insg' ),
		    'content'     => $content,
		)
	);
...
add_action('init', 'insg_register_pros_and_cons_block_pattern');
