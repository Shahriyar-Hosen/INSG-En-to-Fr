<?php
/*
 * Block Pattern - Tool Listing
*/

function insg_register_tool_listing_block_pattern() {
	$content = <<<CONTENT
	...
	<div class="gb-headline gb-headline-54f66a5f gb-headline-text">Any <mark style="background-color:var(--insg-blue)" class="has-inline-color has-insg-white-color">Tools</mark> That<br>I Missed?</div>
	...
	<p class="gb-headline gb-headline-bfcbb51b gb-headline-text">Submit a product for review</p>
	...
	<a class="gb-button gb-button-cd2c7612 gb-button-text" href="/en/contact">ADD A NEW TOOL</a>
...
CONTENT;
	...
	register_block_pattern(
		'insg/tool-listing-pattern',
		array(
		    'title'       => __( 'INSG. Tool Listing', 'insg' ),
		    'description' => _x( 'Custom Tool Listing layout.', 'Block pattern description', 'insg' ),
		    'content'     => $content,
		)
	);
...
add_action('init', 'insg_register_tool_listing_block_pattern');
