<?php
/*
 * Block Pattern - Influenceur
 */

function insg_register_influenceur_block_pattern()
{
	...
	$content = <<<CONTENT
		...
		<div class="gb-headline gb-headline-2e0ac1bf gb-headline-text"><mark style="background-color:var(--insg-blue)" class="has-inline-color has-insg-white-color">Créateurs</mark><br><strong>ou Influenceurs ?</strong></div>
		<!-- /wp:generateblocks/headline -->
		
		<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}},"textColor":"insg-black"} -->
		<p class="has-insg-black-color has-text-color" style="font-size:18px">Construisons votre Campagne et trouvons les meilleurs  Créateurs de Contenu pour votre Marque</p>
		<!-- /wp:paragraph -->
		...
		<a class="gb-button gb-button-0cdb02f7 gb-button-text" href="/en/consulting">TRAVAILLONS ENSEMBLE</a>
...
CONTENT;
	...
	register_block_pattern(
		'insg/influenceur-pattern',
		array(
			'title' => __('INSG. Influenceur', 'insg'),
			'description' => _x('Custom Influenceur layout.', 'Block pattern description', 'insg'),
			'content' => $content,
		)
	);
...
add_action('init', 'insg_register_influenceur_block_pattern');