<?php
/*
 * Block Pattern - Review
*/

function insg_register_review_block_pattern() {
	$content = <<<CONTENT
		...
		<div class="gb-headline gb-headline-cf5c908f gb-headline-text insg_title_with_top_line">Find all Influencers in Malaysia</div>
		<!-- /wp:generateblocks/headline -->
		
		<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"18px"}},"textColor":"insg-black","className":"insg_hero_left_para"} -->
		<p class="has-text-align-left insg_hero_left_para has-insg-black-color has-text-color" style="font-size:18px">If you are looking for Influencers in Malaysia and everywhere in the world. Just do a Free first Influencer research or make a list of Influencers and then contact them yourself. This is the best solution to test Influencer Marketing for FREE.</p>
		<!-- /wp:paragraph -->
		...
		<figure class="wp-block-table is-style-regular" style="font-size:18px"><table><tbody><tr><td><strong>Best For</strong></td><td class="has-text-align-right" data-align="right">Beginners</td></tr><tr><td><strong>Price</strong></td><td class="has-text-align-right" data-align="right">FREE</td></tr><tr><td><strong>Discount</strong></td><td class="has-text-align-right" data-align="right">NO NEED</td></tr><tr><td><strong>Promotion</strong></td><td class="has-text-align-right" data-align="right">IT’S FREE</td></tr></tbody></table></figure>
		<!-- /wp:table -->
		...
		<a class="gb-button gb-button-6ec9573c gb-button-text" href="/en/consulting">100% FREE</a>
...
CONTENT;
	...
	register_block_pattern(
		'insg/review-pattern',
		array(
		    'title'       => __( 'INSG. Review', 'insg' ),
		    'description' => _x( 'Custom Review layout.', 'Block pattern description', 'insg' ),
		    'content'     => $content,
		)
	);
...
add_action('init', 'insg_register_review_block_pattern');
