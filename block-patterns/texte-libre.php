<?php
/*
 * Block Pattern - Texte libre
 */

function insg_register_texte_libre_block_pattern()
{
	...
	$content = <<<CONTENT
		...
		<div class="gb-headline gb-headline-4760c7b5 gb-headline-text">Besoin de plus de <mark style="background-color:var(--insg-blue)" class="has-inline-color has-insg-white-color">services</mark><br> ?</div>
		...
		<p class="gb-headline gb-headline-62e7b71e gb-headline-text">Cadeaux, concours, tirages au sort....</p>
		...
		<a class="gb-button gb-button-13ef0ca0 gb-button-text" href="/en/consulting">COMMENCER</a>
...
CONTENT;
	...
	register_block_pattern(
		'insg/texte-libre-pattern',
		array(
			'title' => __('INSG. Texte libre', 'insg'),
			'description' => _x('Custom Texte libre layout.', 'Block pattern description', 'insg'),
			'content' => $content,
		)
	);
...
add_action('init', 'insg_register_texte_libre_block_pattern');