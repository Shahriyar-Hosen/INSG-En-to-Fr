<?php
/*
 * Block Pattern - Influencer Consulting
*/

function insg_register_influencer_consulting_block_pattern() {
	...
	$content = <<<CONTENT
		...
		<div class="gb-headline gb-headline-69355387 gb-headline-text">Need <mark style="background-color:var(--insg-blue)" class="has-inline-color has-insg-white-color">more</mark><br>influencers</div>
		<!-- /wp:generateblocks/headline -->
		
		<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}},"textColor":"insg-black"} -->
		<p class="has-insg-black-color has-text-color" style="font-size:18px">We can help you to find the best one of your Brand</p>
		<!-- /wp:paragraph -->
		...
		<a class="gb-button gb-button-4ee03dee gb-button-text" href="/en/consulting">LET’S GO</a>
...
CONTENT;
	...
	register_block_pattern(
		'insg/influencer-consulting-pattern',
		array(
		    'title'       => __( 'INSG. Influencer Consulting', 'insg' ),
		    'description' => _x( 'Custom Influencer Consulting layout.', 'Block pattern description', 'insg' ),
		    'content'     => $content,
		)
	);
...
add_action('init', 'insg_register_influencer_consulting_block_pattern');
